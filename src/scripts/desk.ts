...
const STATION_DATA = [
  ...
  },
  {
    ...
    p2: "It is why my product instinct defaults to the boring industries everybody else skips. Real people, served plainly. Nothing fancy, nothing gated.",
    coord: '31.1° N · 75.3° E',
  ...
  },
  {
    ...
    pmL: 'LONDON · DUBAI', pmDate: '2019 — 2024', pmR: '★ FOUNDER ★',
    ...
    p2: "Two exits, $575K combined. Roughly $5M influenced in closed deals (deals my team and I drove, not personal revenue). The real takeaway: I learned product the hard way before I called myself a PM.",
    coord: 'London · 51.5° N · Dubai · 25.2° N',
    grid: [['Era', '2019 — 2024'], ['Companies', 'CloudApproach · Approachables'], ['Exits', 'Two · $575K combined'], ['Took with me', 'Ship before perfect']] as [string, string][],
  },
  {
    ...
    p1: "After the founder years I came to the US and did a master's in AI at <em>Simon Business School</em> (MS AI in Business, December 2025). Then ESC. I am the only AI person on the team. Built Maya in about 2.5 months: voice, chat, SMS, email, mobile, plus an internal console agents use to navigate Oracle CCS.",
    p2: "Pilot is 40+ agents at one US utility. Maya handles first-touch on 70 to 80% of inbound support volume, which removes roughly 100+ manual emails from a manager's inbox per day. That is the only metric I will defend in a one-on-one with the engineer who built the thing.",
    coord: '43.2° N · 77.6° W',
